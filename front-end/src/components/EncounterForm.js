        ...
        let postOption = {
            ...
            body: JSON.stringify({ 
                encounter: {
                    ...
                    hpi: `Onset of ${createEncounterChiefComplaintInput} began on ${createEncounterOnsetInput}, which has lasted for ${createEncounterDurationInput}. ${createEncounterChiefComplaintInput} is located in ${createEncounterLocationInput} and is ${createEncounterCharacterInput} in character. Patient states is ${createEncounterSeverityInput}. Modifying factors include ${createEncounterModifyingFactorsInput}. Associating symptoms include ${createEncounterAssociatedSymptomsInput}.`,
                    ros: `Onset of ${createEncounterChiefComplaintInput} began on ${createEncounterOnsetInput}, which has lasted for ${createEncounterDurationInput}. ${createEncounterChiefComplaintInput} is located in ${createEncounterLocationInput} and is ${createEncounterCharacterInput} in character. Patient states severity is ${createEncounterSeverityInput}. Modifying factors include ${createEncounterModifyingFactorsInput}. Associating symptoms include ${createEncounterAssociatedSymptomsInput}.`,
                    physical_exam: `General: ${createEncounterGeneralInput},
                        ...
                        Ob/Gyn & Breast (female only): ${createEncounterOBGYNBreastInput},
